...
public class ChargeurLabyrinthe {
	...
	public static Labyrinthe chargerLabyrinthe(String fileName) throws IOException {
		...
		try {
			...
			throw new IOException("Le fichier ne contient pas un Labyrinthe.", e);
	 ...
	 */
	public static void sauverLabyrinthe(String fileName, Labyrinthe laby)throws IOException {
	 ...
	 */
	public static void sauverLabyrintheEnXML(String fileName, Labyrinthe laby)throws IOException {
