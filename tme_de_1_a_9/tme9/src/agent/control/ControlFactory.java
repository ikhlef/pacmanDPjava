...
//		System.out.println(c);
	...
	public static IControleur createSmartControleur(){
		Controleur c = new Controleur();
	...
	private static Random generateur = Generateur.getGenerateur(0).getRandom();
	...
	static Regle generateRandomRule() {
		...
		for (int i = 0; i < 8; i++) {
			double rand = Generateur.getGenerateur(0).getRandom().nextDouble();
			if (rand > 0.20)
				// 80% joker
